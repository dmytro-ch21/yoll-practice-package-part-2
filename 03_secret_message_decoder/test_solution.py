...
class TestSecretMessageDecoder:
    ...
    @patch('builtins.input', side_effect=['H9=tXhXRoce@u:Tl={q5lB3*no})mU .z[eW+di^oQ4UBr&-uvl zfVdlPte!Oe;2', '5'])
    def test_hello_world_message(self, capsys):
        solution.main()
    ...
    def test_inspiration_message(self, capsys):
        solution.main()
        captured = capsys.readouterr()
    ...
    def test_secret_password(self, capsys):
        solution.main()
        captured = capsys.readouterr()
    ...
    def test_step_size_one(self, capsys):
        solution.main()
        captured = capsys.readouterr()
    ...
    def test_every_second_character(self, capsys):
        solution.main()
        captured = capsys.readouterr()
    ...
    def test_invalid_step_non_numeric(self, capsys):
    ...
    def test_invalid_step_zero(self, capsys):
        with pytest.raises(SystemExit):
            solution.main()
    ...
    def test_invalid_step_negative(self, capsys):
        with pytest.raises(SystemExit):
            solution.main()
